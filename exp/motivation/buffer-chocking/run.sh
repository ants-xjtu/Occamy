...
run-background() {
  ...
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6666 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6667 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6668 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6669 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6610 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6611 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6612 -D"

  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6613 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6614 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6615 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6616 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6617 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6618 -D"
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns1 iperf3 -s -p 6619 -D"

  ssh root@192.168.1.3 "pkill iperf"
  nohup ssh root@192.168.1.3 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6666 -t 0 -S 32 &" >/dev/null &
  nohup ssh root@192.168.1.3 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6667 -t 0 -S 64 &" >/dev/null &
  nohup ssh root@192.168.1.3 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6668 -t 0 -S 96 &" >/dev/null &
  nohup ssh root@192.168.1.3 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6669 -t 0 -S 128 &" >/dev/null &
  nohup ssh root@192.168.1.3 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6610 -t 0 -S 160 &" >/dev/null &
  nohup ssh root@192.168.1.3 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6611 -t 0 -S 192 &" >/dev/null &
  nohup ssh root@192.168.1.3 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6612 -t 0 -S 224 &" >/dev/null &

  ssh root@192.168.1.4 "pkill iperf"
  nohup ssh root@192.168.1.4 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6613 -t 0 -S 32 &" >/dev/null &
  nohup ssh root@192.168.1.4 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6614 -t 0 -S 64 &" >/dev/null &
  nohup ssh root@192.168.1.4 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6615 -t 0 -S 96 &" >/dev/null &
  nohup ssh root@192.168.1.4 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6616 -t 0 -S 128 &" >/dev/null &
  nohup ssh root@192.168.1.4 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6617 -t 0 -S 160 &" >/dev/null &
  nohup ssh root@192.168.1.4 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6618 -t 0 -S 192 &" >/dev/null &
  nohup ssh root@192.168.1.4 "nohup ip netns exec ns1 iperf3 -C dctcp -c 192.168.40.20 -p 6619 -t 0 -S 224 &" >/dev/null &
}
...
run-incast-server() {
  ...
  sleep 5
  ssh root@${ONE_CLIENT_IP} "ip netns exec ns2 /home/ygli/TrafficGenerator/bin/server -C DCTCP -p 6001 -d"
...
configure() {
  ...
  query_info+="server 192.168.40.21 6001 1\n"
...
main() {
  ...
  for query_size in ${query_sizes[@]}; do
    ...
    sleep 5
    download-result DT_b $query_size
  done
